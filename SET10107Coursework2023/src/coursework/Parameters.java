...
public class Parameters {
	...
	public static int tounamentSize = 10;

	// Parameters for mutation
	// Rate = probability of changing a gene
	// Change = the maximum +/- adjustment to the gene value
	public static double mutateRate = 0.4; // 0.01 mutation rate for mutation operator
	public static double mutateChange = 0.7; // delta change for mutation operator
